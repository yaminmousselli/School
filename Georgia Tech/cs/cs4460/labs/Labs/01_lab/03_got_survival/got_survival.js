...
function updateBars(house) {
    ...
    //You're chaining this call to the already sorted array
    filteredCharacters.sort(function(characterA, characterB) {
        //Ascending Order, 0 means equal, + number means B is sorted before A, - number means A is sorted before B
        //return characterA['probability_of_survival'] - characterB['probability_of_survival'];
