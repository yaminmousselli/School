...
class MySet<E> implements SimpleSet<E> {
    ...
    //This is to fully qualify it and that you're talking about size in MySet.
            return index < MySet.this.size();
        }

        @Override
        public E next() throws NoSuchElementException {
            if (hasNext()) {
                E toBeReturned = data[index];
                index++;
                return toBeReturned;
            }
            throw new NoSuchElementException("Element isn't here");
        }
    }
