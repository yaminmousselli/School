...
public class Model {
    ...
    public static void standings(int choice) {
        ...
        case 2:
            ...
            Collections.sort(civs, new Comparator<Civilization>() {
                ...
                public int compare(Civilization civ1, Civilization civ2) {
                    return civ2.getHappiness() - civ1.getHappiness();
                }
            });
        ...
        case 3:
            ...
            Collections.sort(civs, new Comparator<Civilization>() {
                @Override
                public int compare(Civilization civ1, Civilization civ2) {
                    return civ2.getTechnology().getTechPoints()
                        - civ1.getTechnology().getTechPoints();
                }
            });
        ...
        case 4:
            //Amount of resources
            Collections.sort(civs, (Civilization civ1, Civilization civ2) -> {
                    return civ2.getResources() - civ1.getResources();
                }
            );
            System.out.println("People with the finest Resources:");
            for (Civilization civ : civs) {
                System.out.println(i + " " + civ + ": " + civ.getResources());
                i++;
            }
            break;
        case 5:
            ...
            Collections.sort(civs, new Comparator<Civilization>() {
                @Override
                public int compare(Civilization civ1, Civilization civ2) {
                    if (civ1.getNumSettlements()
                        - civ2.getNumSettlements() == 0) {
                        return civ1.compareTo(civ2);
                    }
                    return civ2.getNumSettlements() - civ1.getNumSettlements();
                }
            });
            System.out.println("People with the Fanciest Crowns");
            for (Civilization civ : civs) {
                System.out.println(i + " " + civ + ": Settlements - "
    ...
    public static String gameScreen() {
        ...
        String gameScreen = map.toString()
            ...
            + "Stats:\n"
            + "Philosophy Points: " + civ.getTechnology().getUnderg()
            + "\t"
